...
def biggest_cast
  ...
  #
  # Find the id and title o 
Movie.select(:id, :title).joins(:actors).group('movie_id').order('COUNT(actors.id) DESC').limit(2) 
...
def movie_names_before_1940  # Consider the following:
  #
